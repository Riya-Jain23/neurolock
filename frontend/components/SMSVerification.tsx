...
export function SMSVerification({ navigation, route }: SMSVerificationProps) {
  ...
  const sendCode = () => {
    // Mock sending SMS
    Alert.alert('SMS Sent', `A verification code was sent to ${phone || 'your phone'}`);
    setSeconds(60);
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.subtitle}>We sent a 6-digit code to {phone || 'your phone'}</Text>
        </View>
      </View>
      ...
      <View style={styles.content}>
        <Input
          ...
          leftIcon={<IconButton icon="message-text" size={20} />}
        />
